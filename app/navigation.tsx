      ...
      <div style={{display: 'flex', gap: '20px', alignItems: 'center'}}>
        {role === 'employee' && (
          <>
            ...
            <a href="/goals" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>My Goals</a>
            <a href="/achievements" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Achievements</a>
          </>
        )}
        {role === 'manager' && (
          <>
            <a href="/dashboard" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Dashboard</a>
            <a href="/approvals" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Approvals</a>
            <a href="/checkins" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Check-ins</a>
          </>
        )}
        {role === 'admin' && (
          <>
            <a href="/dashboard" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Dashboard</a>
            <a href="/approvals" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Approvals</a>
            <a href="/goals" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>All Goals</a>
            <a href="/shared-goals" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Shared Goals</a>
            <a href="/completion" style={{color: 'white', textDecoration: 'none', fontSize: '14px'}}>Completion</a>
